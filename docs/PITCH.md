...
| **Bank of America (US)** | "Erica" virtual assistant (text-first, in-app) | **2 billion+ interactions, 42M clients** since 2018; second billion took 18 months vs 4 years for the first | Primary ([BofA newsroom, Apr 2024](https://newsroom.bankofamerica.com/content/newsroom/press-releases/2024/04/bofa-s-erica-surpasses-2-billion-interactions--helping-42-millio.html)) |
